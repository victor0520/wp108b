...
const Pos = {
  ...
  Pos.calcPrice = function () {
    ...
    if(a=="紅茶:20"){document.getElementById("image").src = "紅茶.jpg";}
    if(a=="綠茶:20"){document.getElementById("image").src = "綠茶.jpg";}
    if(a=="熱可可:40"){document.getElementById("image").src = "熱可可.jpg";}
    if(a=="珍珠奶茶:35"){document.getElementById("image").src = "珍奶.jpg";}
